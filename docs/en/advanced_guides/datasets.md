...
and (2) send data into [dataset transform pipeline](https://github.com/vbti-development/onedl-mmsegmentation/blob/main/mmseg/datasets/basesegdataset.py#L141) to do [data augmentation](./transforms.md).
...
It inherits [`BaseDataset` of MMEngine](https://github.com/vbti-development/onedl-mmengine/blob/main/docs/en/advanced_tutorials/basedataset.md) and follows unified initialization process of OneDL Lab. It supports the highly effective interior storing format, some functions like
...
[`load_data_list`](https://github.com/vbti-development/onedl-mmsegmentation/blob/main/mmseg/datasets/basesegdataset.py#L231) of `BaseSegDataset` in MMSegmentation.
...
If the dataset directory structure is organized as below, the [`load_data_list`](https://github.com/vbti-development/onedl-mmsegmentation/blob/main/mmseg/datasets/basesegdataset.py#L231) can parse dataset directory Structure:
...
The segmentation label would re-map class information by `label_map`, [here](https://github.com/vbti-development/onedl-mmsegmentation/blob/main/mmseg/datasets/basesegdataset.py#L151) is detailed implementation:
