...
It inherits [`BaseDataset` of MMEngine](https://github.com/vbti-development/onedl-mmengine/blob/main/docs/en/advanced_tutorials/basedataset.md) and follows unified initialization process of OpenMMLab. It supports the highly effective interior storing format, some functions like
